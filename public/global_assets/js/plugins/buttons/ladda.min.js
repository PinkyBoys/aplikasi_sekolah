                        ...
                        d ||
                            (d = (function (e) {
                                ...
                                e.hasAttribute("data-spinner-size") &&
                                    (n = parseInt(
                                        e.getAttribute("data-spinner-size"),
                                        10
                                    ));
                                ...
                                e.hasAttribute("data-spinner-lines") &&
                                    (u = parseInt(
                                        e.getAttribute("data-spinner-lines"),
                                        10
                                    ));
                                var i = 0.2 * n;
                                return new t({
            ...
            t.addEventListener(
                ...
                function () {
                    ...
                    if (void 0 !== d && !d.hasAttribute("novalidate"))
                        if ("function" == typeof d.checkValidity)
                            r = d.checkValidity();
                        else
                            for (
                                var o =
                    ...
                    r &&
                        ...
                        "number" == typeof e.timeout &&
                            (clearTimeout(n),
                            (n = setTimeout(u.stop, e.timeout))),
                        "function" == typeof e.callback &&
                            e.callback.apply(null, [u]));
                },
                !1
            );
        }
